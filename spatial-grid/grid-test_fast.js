import { spatial_grid } from './spatial-hash-grid_fast.js';
...
for (let i = 0; i < _NUM_CLIENTS; ++i) {
  _CLIENT_POSITIONS.push(
      [
          rand_range(_CLIENT_BOUNDS[0][0], _CLIENT_BOUNDS[1][0]),
          rand_range(_CLIENT_BOUNDS[0][1], _CLIENT_BOUNDS[1][1])
      ]);
}
...
const gridSlow = new GridTester(spatial_grid.SpatialHash_Slow);
...
console.log('Spatial Grid (Fast)- FindNearby: ' + gridFast.Test_FindNearby() + 'ms');
console.log('----------------------------------');
console.log('Spatial Grid (Naive) - FindNearby: ' + gridSlow.Test_FindNearby() + 'ms');
console.log('Spatial Grid (Fast)- FindNearby: ' + gridFast.Test_FindNearby() + 'ms');
...
console.log('Spatial Grid (Fast) - Update: ' + gridFast.Test_Update() + 'ms');
console.log('----------------------------------');
console.log('Spatial Grid (Naive) - Update: ' + gridSlow.Test_Update() + 'ms');
console.log('Spatial Grid (Fast) - Update: ' + gridFast.Test_Update() + 'ms');